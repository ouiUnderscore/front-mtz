  ...
  <div class="min-h-screen bg-zinc-950 text-white">
    ...
    <main class="max-w-6xl mx-auto px-6 pt-28 pb-16">
      ...
      <div class="mt-6 bg-zinc-900 border border-red-900/40 rounded-xl p-6">
        <h2 class="text-xs text-red-500 tracking-widest uppercase font-semibold mb-4">Zone de danger</h2>
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <p class="text-zinc-200 text-sm font-medium">Supprimer mon compte</p>
            <p class="text-zinc-500 text-xs mt-1">Cette action est irréversible et supprime toutes vos données.</p>
          </div>
          <button
