<template>
  <div class="min-h-screen bg-zinc-950 flex flex-col">
    ...
    <!-- Modale suppression -->
    <div v-if="modalSuppressionOuverte" class="fixed inset-0 z-50 flex items-center justify-center px-4">
      <div class="absolute inset-0 bg-black/70 backdrop-blur-sm" @click="fermerModalSuppression"></div>
      ...
      >
        <div class="flex flex-col items-center gap-4 mb-6">
          ...
          <p class="text-zinc-400 text-center text-sm leading-relaxed">
            ...
            <span class="text-white font-semibold">« {{ film?.titre }} »</span> ?
...
async function confirmerSuppression() {
  ...
  try {
    ...
    else if (status === 403) erreurSuppression.value = 'Vous n\'avez pas les droits pour supprimer ce film.'
